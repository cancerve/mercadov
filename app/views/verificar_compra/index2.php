	...
	if ($_GET['mensaje']=='Perfil'){
		...
		$cantRSUsuario	= $objConexion->cantidadRegistros($RSUsuario);
			...
			if ($cantRSUsuario>0){
				...
				echo '<b>UBICACION: </b>'.ucwords(strtolower($AL_NombreSede)).'</br>'.$AL_NombreGerencia;
			}
		}
		
		///////////VER ORDEM ////
		if ($_GET['mensaje']=='Orden'){
			echo '<iframe src="../pedido/orden_compra.php?pedido_NU_IdPedido='.$_GET['NU_IdPedido'].'" name="orden" width="450" height="215" vspace="0" scrolling="yes" frameborder="0"></iframe>';
		}
	?>
    </p>
</div>
...
<!--          <th width="67" align="center" scope="col">APROBAR</th>
    ...
    ?>
        <tr>
          ...
          <td align="center" class="TablaRojaGridTD"><?php echo number_format($NU_Cedula,0,'','.'); ?></td>
          <td align="left"   class="TablaRojaGridTD"><?php echo $AL_Nombre.' '.$AL_Apellido; ?></td>
          <td align="center" class="TablaRojaGridTD"><?php echo $CantProductos; ?></td>
          <td align="center" class="TablaRojaGridTD"><?php echo number_format($MontoPagar,2,',','.').' BsF.'; ?></td>
          <td align="center" class="TablaRojaGridTD"><a href="index2.php?mensaje=Perfil&mercado_NU_IdMercado=<?=$_REQUEST['mercado_NU_IdMercado']?>&NU_Cedula=<?=$NU_Cedula?>"><img src="../../images/bton_ver.gif" width="31" height="31"></a></td>
          ...
          <td align="center" class="TablaRojaGridTD">
          	<a href="../pedido/orden_compra.php?pedido_NU_IdPedido=<?=$NU_IdPedido?>" target="_blank">
            <img src="../../images/bton_ver.gif" width="31" height="31"></a>
          </td>
        </tr>
	<?php
	    }
    ...
    <tr>
      <td height="25" align="center"><!--<table width="50" border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td align="center">&nbsp;</td>
          <td align="center">&nbsp;</td>
          <td align="center">&nbsp;</td>
      ...
      <input name="button" type="button" class="BotonRojo" id="button" value="[ Atrás ]" onClick="javascript:window.location='index.php'" /></td>
    </tr>
  </table>
</body>
</html>