            ...
            <td><table class="TablaRojaGrid" width="100%">
              ...
              <tr>
                <td><p>Hemos enviado un mensaje con su nueva clave de acceso a su correo: <strong><?php echo $_GET['AF_Correo']?></strong></p>
                  ...
                  <p>En última instancia se puede comunicar con nosotros al correo: <a href="mailto:soporte.mercadov@venalcasa.net.ve">soporte.mercadov@venalcasa.net.ve</a> indicando su problema.</p></td>
              </tr>
              <tr>
