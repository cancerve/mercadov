...
<div id="dialog" title="Mensaje" style="display:none;">
  ...
  <table class="Textonegro" width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="25" align="left" bgcolor="#CCCCCC" class="Negrita">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CONSULTAS / INVENTARIO</td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="center"><form name="form1" method="post" action="../../../controller/inventarioController.php" target="_blank">
        <table width="400" border="0" cellspacing="2" cellpadding="2" class="TablaRojaGrid">
          ...
          <tr>
            <td align="center"><input name="origen" type="hidden" id="origen" value="inventario"></td>
